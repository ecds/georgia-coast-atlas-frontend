...
// routes/collections.videos._index.tsx

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../+types/root.js"

type Module = typeof import("../collections.videos._index.js")

export type Info = {
  parents: [Parent0],
  id: "routes/collections.videos._index"
  file: "routes/collections.videos._index.tsx"
