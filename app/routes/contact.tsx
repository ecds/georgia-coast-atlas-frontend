        ...
        <form className="flex flex-col space-y-6">
          <div className="flex flex-col">
            ...
            <input
              ...
              id="name"
              placeholder="Name"
              className="px-4 py-2 rounded-md border border-gray-300 focus:outline-hidden focus:ring-2 focus:ring-blue-500 text-black"
            />
          </div>
          <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <textarea
              ...
              placeholder="Message"
              rows={5}
              className="px-4 py-2 rounded-md border border-gray-300 focus:outline-hidden focus:ring-2 focus:ring-blue-500 text-black resize-none"
            />
          </div>
          <button
            type="submit"
